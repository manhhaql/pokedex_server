...
var PokemonAbilityRoute = function () {
    function PokemonAbilityRoute() {
        _classCallCheck(this, PokemonAbilityRoute);
    ...
    _createClass(PokemonAbilityRoute, [{
        key: 'list',
        ...
        value: function set(req, res, next) {
            ...
            this.redisCore.getRedisToken({
                ...
                return _this.propertiesCore.getAbility({});
            }).then(function (result) {
                abilityData = result.map(function (ability) {
                    return ability.id;
                });

                differents = setAbilityData.filter(function (a) {
                    return !abilityData.includes(a);
                });
                ...
                return _this.pokemonAbilityCore.delete({
                    pokemon_id: paramValues.value.pokemon_id
                });
            }).then(function (results) {
                return Promise.all(paramValues.value.abilities.map(function (ability_id) {
                    return new Promise(function (resolve, reject) {
                        _this.pokemonAbilityCore.set({
                            pokemon_id: paramValues.value.pokemon_id,
    ...
    return PokemonAbilityRoute;
}();

;

exports.default = PokemonAbilityRoute;